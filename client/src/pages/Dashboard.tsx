...
// Observe: Não importamos mais a Sidebar nem o Menu aqui!
...
export const Dashboard: React.FC = () => {
  ...
  // O RETORNO MUDOU:
  // 1. Removemos o <div flex h-screen> (O Layout já faz isso)
  // 2. Removemos a <Sidebar /> (O Layout já renderiza ela)
  // 3. Removemos a tag <main> (O Layout já tem o main)
  // 4. Removemos o padding container externo (O Layout já aplica padding)
    ...
    <div className="space-y-6 lg:space-y-8 animate-in fade-in duration-500">
      ...
      <section className="bg-[#193324] rounded-xl overflow-hidden border border-white/5 flex flex-col lg:flex-row shadow-2xl">
        <div className="w-full lg:w-1/3 bg-slate-800 h-48 lg:h-auto relative">
            {/* Placeholder de imagem se quiser */}
